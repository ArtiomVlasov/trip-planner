                ...
                "candidates": [
                    {
                        "content": {
                            "parts": [
                                {
                                    "text": '{"routeQueries":["Сочи, ул. Горького, 56","Сочи, ул. Войкова, 1","Сочи, Курортный пр., 74","Сочи, ул. Навагинская, 12","Сочи, ул. Егорова, 1","с. Казачий Брод, ул. Краснофлотская, 54А","Сочи, дорога на Большой Ахун, 1"]}'
                                }
                            ]
                        }
                    }
...
def test_gemini_route_planner_recovers_route_queries_from_malformed_json(monkeypatch):
                ...
                "candidates": [
                    {
                        "content": {
                            "parts": [
                                {
                                    "text": '{"routeQueries":["Сочи, Курортный пр., 74","Сочи, ул. Егорова, 1","Сочи, ул. Черноморская, 11","Сочи, ул. Приморская, 19","Адлер, ул. Нагорный тупик, 13Б, Парк "Южные культуры"","Сириус, Олимпийский пр., 21","Хоста, Воронцовка, Воронцовские пещеры","Сочи, Агурское ущелье, Орлиные скалы"]}'
                                }
                            ]
                        }
                    }
    ...
    assert 'Адлер, ул. Нагорный тупик, 13Б, Парк "Южные культуры"' in queries
