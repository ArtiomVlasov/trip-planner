...
export const translations = {
  ru: {
    ...
    sidebar: {
      ...
      partnerPlaces: "Мои точки",
      partnerStats: "Статистика",
      login: "Войти",
      signup: "Регистрация",
    ...
    chat: {
      ...
      regenerationPointsDescription:
        "Откройте карточку нужной точки и нажмите «Заменить», чтобы написать отдельный промт для её замены.",
      ...
      regenerationReplacementSingleFallback: "Замени эту точку маршрута.",
      regenerationReplacementDialogTitle: "Чем заменить точку",
      regenerationReplacementDialogDescription: "Напишите, какой должна стать эта точка маршрута:",
      regenerationReplacementDialogCancel: "Отмена",
      ...
      routeSavedCardDescription:
        "Маршрут сохранён в профиле, в разделе сохранённых маршрутов. Оттуда к нему можно вернуться позже.",
    ...
    partnerPlaces: {
      ...
      profilePageTitle: "Профиль партнёра",
      profilePageDescription:
        "Основные данные партнёрского аккаунта и сводка по подключённым точкам.",
      placesPageTitle: "Мои точки",
      placesPageDescription:
        "Добавляйте точки, редактируйте карточки и управляйте их продвижением.",
      statisticsPageTitle: "Статистика",
      statisticsPageDescription:
        "Отдельная витрина показов, добавлений в маршрут и активности по точкам.",
      sectionNavigation: "Разделы кабинета партнёра",
      profileLoadError: "Не удалось загрузить профиль партнёра.",
      profileLoading: "Загружаем профиль партнёра...",
      profileCompanyName: "Название",
      profileLogin: "Логин",
      profilePartnerId: "ID партнёра",
      profileCity: "Город",
      profileContactName: "Контактное лицо",
      profileContactEmail: "Email для связи",
      profileCreatedAt: "Создан",
      profileUpdatedAt: "Обновлён",
      profileSummaryTitle: "Сводка аккаунта",
  ...
  en: {
    ...
    sidebar: {
      ...
      partnerPlaces: "My Places",
      partnerStats: "Statistics",
      login: "Log In",
      signup: "Sign Up",
    ...
    chat: {
      ...
      regenerationPointsDescription:
        "Open the place card and click Replace to write a dedicated prompt for that route point.",
      ...
      regenerationReplacementSingleFallback: "Replace this route point.",
      regenerationReplacementDialogTitle: "How should this point change",
      regenerationReplacementDialogDescription: "Describe what this route point should be replaced with:",
      regenerationReplacementDialogCancel: "Cancel",
      ...
      routeSavedCardDescription:
        "The route is saved in your profile under saved routes, so you can return to it later.",
    ...
    partnerPlaces: {
      ...
      profilePageTitle: "Partner Profile",
      profilePageDescription:
        "Core partner account details and a quick summary of connected places.",
      placesPageTitle: "My Places",
      placesPageDescription:
        "Add locations, edit cards, and manage their promotion status.",
      statisticsPageTitle: "Statistics",
      statisticsPageDescription:
        "A separate view for impressions, route additions, and activity by place.",
      sectionNavigation: "Partner panel sections",
      profileLoadError: "Failed to load partner profile.",
      profileLoading: "Loading partner profile...",
      profileCompanyName: "Name",
      profileLogin: "Login",
      ...
      profileSummaryTitle: "Account summary",
